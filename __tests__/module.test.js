...
it('should retrieve the module with the corresponding id', async done => {
    ...
    const response = await request.get('/module/ikarie')
...
it('should display only modules with instock: true', async done => {
    ...
    const response = await request.get('/instock')
...
it('should retrieve modules in order from cheapest to most expensive', async done => {
    ...
    const response = await request.get('/sortby/price')
